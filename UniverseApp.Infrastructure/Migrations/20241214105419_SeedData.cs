    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "18990560-1cca-49b8-b4db-5adb987559c3", 0, "e0b2f0ad-7828-4497-9995-8fbabf1117ae", "user@mail.com", true, "First", true, "User", false, null, "USER@MAIL.COM", "USER@MAIL.COM", "AQAAAAIAAYagAAAAEDIQ54JbNupgH7wiCfQtilz0N0SysuocdIVwMbFjO18dbtJckzm6DUEyWuRwL+TRmg==", null, false, "edf5205e-96f6-4a8c-988b-44f7b23c4600", false, "user@mail.com" },
                    { "cfcc5c95-4666-4fe1-b26a-50c4016dac21", 0, "b2667625-221b-4d6e-85e1-cab2540b1c02", "yoda@mail.com", true, "Yoda", true, "Master", false, null, "YODA@MAIL.COM", "YODA@MAIL.COM", "AQAAAAIAAYagAAAAEHjie/1AeYJLzjYl8A/okupp9mNwUcEJmB0uo5nUqgkklnSBXFanNbQewtqAFGVkWw==", null, false, "b5d6e149-6850-41e3-9bc0-a6c84ebe414e", false, "yoda@mail.com" }
                });

            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "Id", "Description", "Director", "EpisodeId", "ImageUrl", "IsDeleted", "Name", "Producer", "ReleaseDate", "Url" },
                values: new object[,]
                {
                    { 1, "It is a period of civil war.\r\nRebel spaceships, striking\r\nfrom a hidden base, have won\r\ntheir first victory against\r\nthe evil Galactic Empire.\r\n\r\nDuring the battle, Rebel\r\nspies managed to steal secret\r\nplans to the Empire's\r\nultimate weapon, the DEATH\r\nSTAR, an armored space\r\nstation with enough power\r\nto destroy an entire planet.\r\n\r\nPursued by the Empire's\r\nsinister agents, Princess\r\nLeia races home aboard her\r\nstarship, custodian of the\r\nstolen plans that can save her\r\npeople and restore\r\nfreedom to the galaxy....", "George Lucas", "4", "", false, "A New Hope", "Gary Kurtz, Rick McCallum", new DateTime(1977, 5, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://swapi.dev/api/films/1/" },
                    { 2, "It is a dark time for the\r\nRebellion. Although the Death\r\nStar has been destroyed,\r\nImperial troops have driven the\r\nRebel forces from their hidden\r\nbase and pursued them across\r\nthe galaxy.\r\n\r\nEvading the dreaded Imperial\r\nStarfleet, a group of freedom\r\nfighters led by Luke Skywalker\r\nhas established a new secret\r\nbase on the remote ice world\r\nof Hoth.\r\n\r\nThe evil lord Darth Vader,\r\nobsessed with finding young\r\nSkywalker, has dispatched\r\nthousands of remote probes into\r\nthe far reaches of space....", "Irvin Kershner", "5", "", false, "The Empire Strikes Back", "Gary Kurtz, Rick McCallum", new DateTime(1980, 5, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://swapi.dev/api/films/2/" },
                    { 3, "Luke Skywalker has returned to\r\nhis home planet of Tatooine in\r\nan attempt to rescue his\r\nfriend Han Solo from the\r\nclutches of the vile gangster\r\nJabba the Hutt.\r\n\r\nLittle does Luke know that the\r\nGALACTIC EMPIRE has secretly\r\nbegun construction on a new\r\narmored space station even\r\nmore powerful than the first\r\ndreaded Death Star.\r\n\r\nWhen completed, this ultimate\r\nweapon will spell certain doom\r\nfor the small band of rebels\r\nstruggling to restore freedom\r\nto the galaxy...", "Richard Marquand", "6", "", false, "Return of the Jedi", "Howard G. Kazanjian, George Lucas, Rick McCallum", new DateTime(1983, 5, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://swapi.dev/api/films/3/" },
                    { 4, "Turmoil has engulfed the\r\nGalactic Republic. The taxation\r\nof trade routes to outlying star\r\nsystems is in dispute.\r\n\r\nHoping to resolve the matter\r\nwith a blockade of deadly\r\nbattleships, the greedy Trade\r\nFederation has stopped all\r\nshipping to the small planet\r\nof Naboo.\r\n\r\nWhile the Congress of the\r\nRepublic endlessly debates\r\nthis alarming chain of events,\r\nthe Supreme Chancellor has\r\nsecretly dispatched two Jedi\r\nKnights, the guardians of\r\npeace and justice in the\r\ngalaxy, to settle the conflict....", "George Lucas", "1", "", false, "The Phantom Menace", "Rick McCallum", new DateTime(1999, 5, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://swapi.dev/api/films/4/" },
                    { 5, "There is unrest in the Galactic\r\nSenate. Several thousand solar\r\nsystems have declared their\r\nintentions to leave the Republic.\r\n\r\nThis separatist movement,\r\nunder the leadership of the\r\nmysterious Count Dooku, has\r\nmade it difficult for the limited\r\nnumber of Jedi Knights to maintain \r\npeace and order in the galaxy.\r\n\r\nSenator Amidala, the former\r\nQueen of Naboo, is returning\r\nto the Galactic Senate to vote\r\non the critical issue of creating\r\nan ARMY OF THE REPUBLIC\r\nto assist the overwhelmed\r\nJedi....", "George Lucas", "2", "", false, "Attack of the Clones", "Rick McCallum", new DateTime(2002, 5, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://swapi.dev/api/films/5/" },
                    { 6, "War! The Republic is crumbling\r\nunder attacks by the ruthless\r\nSith Lord, Count Dooku.\r\nThere are heroes on both sides.\r\nEvil is everywhere.\r\n\r\nIn a stunning move, the\r\nfiendish droid leader, General\r\nGrievous, has swept into the\r\nRepublic capital and kidnapped\r\nChancellor Palpatine, leader of\r\nthe Galactic Senate.\r\n\r\nAs the Separatist Droid Army\r\nattempts to flee the besieged\r\ncapital with their valuable\r\nhostage, two Jedi Knights lead a\r\ndesperate mission to rescue the\r\ncaptive Chancellor....", "George Lucas", "3", "", false, "Revenge of the Sith", "Rick McCallum", new DateTime(2005, 5, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "https://swapi.dev/api/films/6/" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 2, null, null, "artificial", "sentient", "n/a", "n/a", false, "n/a", "Droid", null, "n/a", "https://swapi.dev/api/species/2/" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, 170, null, "sentient", "reptilian", "black", "n/a", false, "Galatic Basic", "Rodian", 23, "green, blue", "https://swapi.dev/api/species/4/" },
                    ...
                    { 7, 200, null, "reptile", "sentient", "yellow, orange", "none", false, "Dosh", "Trandoshan", 29, "brown, green", "https://swapi.dev/api/species/7/" },
                    { 8, 160, null, "amphibian", "sentient", "yellow", "none", false, "Mon Calamarian", "Mon Calamari", 31, "red, blue, brown, magenta", "https://swapi.dev/api/species/8/" },
                    { 9, 100, null, "mammal", "sentient", "orange, brown", "white, brown, black", false, "Ewokese", "Ewok", 7, "brown", "https://swapi.dev/api/species/9/" },
                    { 10, 180, null, "mammal", "sentient", "black", "none", false, "Sullutese", "Sullustan", 33, "pale", "https://swapi.dev/api/species/10/" },
                    { 11, 180, null, "unknown", "sentient", "red, pink", "none", false, "Neimoidia", "Neimodian", 18, "grey, green", "https://swapi.dev/api/species/11/" },
                    { 12, 190, null, "amphibian", "sentient", "orange", "none", false, "Gungan basic", "Gungan", 8, "brown, green", "https://swapi.dev/api/species/12/" },
                    { 13, 120, 91, "mammal", "sentient", "yellow", "none", false, "Toydarian", "Toydarian", 34, "blue, green, grey", "https://swapi.dev/api/species/13/" },
                    { 14, 100, null, "mammal", "sentient", "yellow, blue", "none", false, "Dugese", "Dug", 35, "brown, purple, grey, red", "https://swapi.dev/api/species/14/" },
                    { 15, 200, null, "mammals", "sentient", "blue, brown, orange, pink", "none", false, "Twi'leki", "Twi'lek", 37, "orange, yellow, blue, green, pink, purple, tan", "https://swapi.dev/api/species/15/" },
                    { 16, 80, 79, "reptile", "sentient", "unknown", "none", false, "Aleena", "Aleena", 38, "blue, gray", "https://swapi.dev/api/species/16/" },
                    { 17, 100, null, "unknown", "sentient", "yellow", "none", false, "vulpterish", "Vulptereen", 39, "grey", "https://swapi.dev/api/species/17/" },
                    { 18, 125, null, "unknown", "sentient", "black", "none", false, "Xextese", "Xexto", 40, "grey, yellow, purple", "https://swapi.dev/api/species/18/" },
                    { 19, 200, null, "unknown", "sentient", "orange", "none", false, "Tundan", "Toong", 41, "grey, green, yellow", "https://swapi.dev/api/species/19/" },
                    { 20, 200, null, "mammal", "sentient", "hazel", "red, blond, black, white", false, "Cerean", "Cerean", 43, "pale pink", "https://swapi.dev/api/species/20/" },
                    { 21, 180, 70, "amphibian", "sentient", "black", "none", false, "Nautila", "Nautolan", 44, "green, blue, brown, red", "https://swapi.dev/api/species/21/" },
                    { 22, 180, null, "mammal", "sentient", "brown, orange", "black", false, "Zabraki", "Zabrak", 45, "pale, brown, red, orange, yellow", "https://swapi.dev/api/species/22/" },
                    { 23, null, null, "mammal", "sentient", "blue, indigo", "unknown", false, "unknown", "Tholothian", 46, "dark", "https://swapi.dev/api/species/23/" },
                    { 24, 180, null, "unknown", "sentient", "orange", "none", false, "Iktotchese", "Iktotchi", 47, "pink", "https://swapi.dev/api/species/24/" },
                    ...
                    { 27, 190, null, "amphibian", "sentient", "blue", "none", false, "Chagria", "Chagrian", 50, "blue", "https://swapi.dev/api/species/27/" },
                    { 28, 178, null, "insectoid", "sentient", "green, hazel", "none", false, "Geonosian", "Geonosian", 11, "green, brown", "https://swapi.dev/api/species/28/" },
                    { 29, 180, null, "mammal", "sentient", "blue, green, red, yellow, brown, orange", "black, brown", false, "Mirialan", "Mirialan", 51, "yellow, green", "https://swapi.dev/api/species/29/" },
                    ...
                    { 33, null, null, "mammal", "sentient", "unknown", "none", false, "Skakoan", "Skakoan", 56, "grey, green", "https://swapi.dev/api/species/33/" },
