...
namespace UniverseApp.Controllers
{
    public class MovieController : BaseController
    {
        ...
        {
            var queryResult = await _movieService.GetAllMoviesAsync(
                model.SearchCharacter = string.Empty,
                model.SearchPlanet = string.Empty,
                model.SearchSpecie = string.Empty,
                model.SearchVehicle = string.Empty,
                model.CurrentPage, MovieAllQueryModel.MoviesPerPage);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            MovieDeleteViewModel model = await _movieService.GetMovieDeleteModelByIdAsync(id);
